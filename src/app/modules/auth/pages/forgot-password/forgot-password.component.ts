  ...
  template: `
    <div class="sign-in-card w-full max-w-md">
      ...
      <div class="space-y-5">
        <div class="space-y-4">
          <div>
            <label class="text-[11px] text-muted-foreground uppercase tracking-wider mb-1.5 block"
        ...
        <button
          ...
          @if (loading) {
            <span
              class="inline-block h-3.5 w-3.5 animate-spin rounded-full border-2 border-current border-r-transparent"></span>
          }
