export const en = {
  ...
  media: {
    ...
    instant_deposit: 'Deposit Instant',
    security: 'Keamanan',
    ssl_2fa: 'SSL + 2FA',
    ...
    news_3_body: 'Analysts predict continued growth in gold prices driven by central bank purchases and geopolitical uncertainty. XAU/USD projected to test new resistance levels.',
    ...
    news_6_body: 'Gold and silver see significant upside as global markets react to interest rate decisions. NUMBER9 traders positioned for gains in the commodities sector.',
