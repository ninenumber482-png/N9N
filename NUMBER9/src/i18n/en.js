export const en = {
  ...
  landing: {
    ...
    trusted_by: 'Secure & Trusted',
    trust_licensed: 'Licensed & Regulated',
    trust_secure: 'Secure Payments',
    trust_encrypted: 'SSL Encrypted',
    trust_payout: 'Fast Payouts',
  ...
  deposit: {
    ...
    account_number: 'Account Number',
    manual_method: 'Manual Transfer',
    instructions_title: 'Payment Instructions',
    instructions_desc: 'Please continue the payment according to the system instructions. Payment details will be processed through the available system. Enter the amount and upload your transfer proof below.',
    check_button: 'Check / Load System',
    checking: 'Checking system…',
    account_revealed: 'Destination Account',
    account_bank: 'Bank',
    copy: 'Copy',
    copied: 'Copied',
    reveal_session: 'Session expired, please log in again.',
    reveal_maintenance: 'System under maintenance. Try again later.',
    reveal_no_account: 'No destination account yet. Please contact CS.',
    reveal_failed: 'Could not load account. Try again.',
