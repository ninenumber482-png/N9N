export const id = {
  ...
  landing: {
    ...
    trusted_by: 'Aman & Terpercaya',
    trust_licensed: 'Berlisensi & Teregulasi',
    trust_secure: 'Pembayaran Aman',
    trust_encrypted: 'Terenkripsi SSL',
    trust_payout: 'Penarikan Cepat',
    trust_support: 'Dukungan 24/7',
    trust_fair: 'Terbukti Adil',
  ...
  deposit: {
    ...
    account_number: 'Nomor Rekening',
    manual_method: 'Transfer Manual',
    instructions_title: 'Instruksi Pembayaran',
    instructions_desc: 'Silakan lanjutkan proses pembayaran sesuai instruksi sistem. Detail pembayaran akan diproses melalui sistem yang tersedia. Masukkan nominal dan unggah bukti transfer di bawah ini.',
    check_button: 'Check / Load System',
    checking: 'Memeriksa sistem…',
    account_revealed: 'Rekening Tujuan',
    account_bank: 'Bank',
    copy: 'Salin',
    copied: 'Tersalin',
    reveal_session: 'Sesi habis, silakan login ulang.',
    reveal_maintenance: 'Sistem sedang pemeliharaan. Coba lagi nanti.',
    reveal_no_account: 'Belum ada rekening tujuan. Silakan hubungi CS.',
    reveal_failed: 'Gagal memuat rekening. Coba lagi.',
  ...
  support: {
    ...
    cs_unavailable: 'CS tidak tersedia',
    // ── in-app ticket chat ──
